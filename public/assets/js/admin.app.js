! function(i) {
    ...
    0 < w.length && (g = w.find(_button_submit), w.find(o).on("keyup change", function() {
        ...
        var e = i(this),
            ...
            o = a.action,
            t = a.stage;
        e.parents(".stage-action").find(".toggle-tigger").add(".toggle-class").removeClass("active"), "overview" == o && "undefined" != typeof stage_action_url && (n = stage_action_url), null !== n && t ? (a._token = csrf_token, i.post(n, a).done(function(t) {
            var e;
        ...
        var e = i(this),
            ...
            n = e.data("type"),
            o = e.data("id");
        token = e.data("token") ? e.data("token") : 0, chk_adjust = e.data("_chk") ? e.data("_chk") : 0, adjusted_token = e.data("_adjusted") ? e.data("_adjusted") : 0, base_bonus = e.data("_b_bonus") ? e.data("_b_bonus") : 0, token_bonus = e.data("_t_bonus") ? e.data("_t_bonus") : 0, amount = e.data("_amount") ? e.data("_amount") : 0, swal_icon = "approved" == n ? "info" : "warning", swal_cta = "approved" == n ? "Xác nhận" : "Yes", swal_ctac = "approved" == n ? "" : "danger", "approved" == n && null != amount && amount <= 0 ? show_toast("warning", "Invalid Received Amount!") : swal({
            title: "Bạn chắc chứ?",
            text: "refund" == n ? "Nếu bạn hoàn tiền giao dịch này, tất cả số tiền liên quan đến giao dịch này sẽ được hoàn trả, bao gồm thưởng và điểm." : "",
            icon: swal_icon,
            buttons: {
                cancel: {
                    text: "Hủy",
            ...
            content: {
                ...
                attributes: {
                    placeholder: "refund" == n ? "Viết giải thích..." : "",
                    type: "text"
                }
            },
            dangerMode: !1
        }).then(t => {
            null == t && "" != t || i.post(route('admin.ajax.transactions.update', o), {
                _token: csrf_token,
                req_type: n,
                token: token,
        ...
        swal({
            ...
            buttons: {
                ...
                confirm: {
                    text: "rejected" == t ? "Từ chối" : "Xác nhận",
                    className: "rejected" == t ? "danger" : ""
                }
            },
            dangerMode: "rejected" == t
        }).then(function(t) {
            null == t && "" != t || i.post(route('admin.ajax.transactions.update', tnx_id), e.data()).done(function(t) {
