    ...
    public static function ico_phase()
    {
        ...
        foreach ($all as $ico) {
            $ico->extra = (object) [
                ...
                'vnd' => Transaction::amount_count('vnd', ['stage' => $ico->id]),
                ...
                'mxn' => Transaction::amount_count('mxn', ['stage' => $ico->id]),
                'php' => Transaction::amount_count('php', ['stage' => $ico->id]),
                'chf' => Transaction::amount_count('chf', ['stage' => $ico->id]),
                'thb' => Transaction::amount_count('thb', ['stage' => $ico->id]),
                'sgd' => Transaction::amount_count('sgd', ['stage' => $ico->id]),
                'czk' => Transaction::amount_count('czk', ['stage' => $ico->id]),
                'nok' => Transaction::amount_count('nok', ['stage' => $ico->id]),
                'zar' => Transaction::amount_count('zar', ['stage' => $ico->id]),
                'sek' => Transaction::amount_count('sek', ['stage' => $ico->id]),
                'kes' => Transaction::amount_count('kes', ['stage' => $ico->id]),
                'nad' => Transaction::amount_count('nad', ['stage' => $ico->id]),
                'dkk' => Transaction::amount_count('dkk', ['stage' => $ico->id]),
                'hkd' => Transaction::amount_count('hkd', ['stage' => $ico->id]),
                'huf' => Transaction::amount_count('huf', ['stage' => $ico->id]),
                'pkr' => Transaction::amount_count('pkr', ['stage' => $ico->id]),
                'egp' => Transaction::amount_count('egp', ['stage' => $ico->id]),
                'clp' => Transaction::amount_count('clp', ['stage' => $ico->id]),
                'cop' => Transaction::amount_count('cop', ['stage' => $ico->id]),
                'jmd' => Transaction::amount_count('jmd', ['stage' => $ico->id]),
