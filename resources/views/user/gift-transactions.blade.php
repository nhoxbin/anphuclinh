                    ...
                    <tbody>
                        ...
                        <tr class="data-item" id="tnx-item-{{ $trnx->id }}">
                            ...
                            <td class="data-col dt-bonus">
                                ...
                                <span class="sub sub-symbol">{!! __('Bonus ' . $trnx->meta['type']) . ' ' . $trnx->meta['amount'] . ' thùng' . ($trnx->gift->extra ? (' + ' . $trnx->gift->extra) : null) . '<br /> Địa chỉ: ' . $trnx->meta['order_info']['address'] !!}</span>
                            </td>
