						...
						<div class="card-text">
							...
							<table class="table table-bordered-plain table-lg table-plain-info fs-13">
								...
								<tr>
									...
									<td>
										{!! (gws('env_pcode')) ? show_str(gws('env_pcode')).( nio_status() ? '' : ' <a href="'.route('admin.niolite').'"><span class="text-danger">Not valid</span> - Enter correct code</a>' ) : '<a href="'.route('admin.niolite').'"><span class="text-danger">Not added</span> - Enter your purchase code</a>' !!}
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										{!! (gws('nio_lkey') && nio_status()) ? 'Active <a class="ml-2" href="'.route('admin.niolite', ['revoke' => 'license']).'">Revoke License</a>' : '<a href="'.route('admin.niolite').'"><span class="text-danger">Not active yet</span> - Click here to active</a>' !!}
									</td>
								</tr>
							...
							<table class="table table-bordered-plain table-lg table-plain-info fs-13">
								...
								<tr>
									...
									<td width="24" class="text-center">
										<em class="ti ti-help-alt fs-11" data-toggle="tooltip" data-placement="top" title="The current time of server."></em>
									</td>
